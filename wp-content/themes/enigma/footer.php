		...
		<div class="container">
			...
			<div class="enigma_footer_social_div">
				<ul class="social">
					...
					<li class="linkedin" data-toggle="tooltip" data-placement="top" title="whatsapp"><a href="<?php echo esc_url($wl_theme_options['whatsapp_link']) ; ?>"><i class="fa fa-whatsapp"></i></a></li>
	                <?php } ?>
				</ul>
			</div>
			<?php } ?>			
